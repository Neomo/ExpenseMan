...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b-2 border-[#82d8a7]/40 dark:border-slate-800 transition-colors h-20 px-4 sm:px-6 lg:px-8 flex items-center shadow-sm w-full">

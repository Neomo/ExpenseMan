...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 xl:w-72 hidden md:flex flex-col border-r-2 border-[#82d8a7]/30 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md min-h-[calc(100vh-5rem)] p-4 shrink-0 transition-all gap-4">

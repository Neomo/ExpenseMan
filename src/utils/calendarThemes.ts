...
export const CALENDAR_THEMES: Record<CalendarThemeKey, ThemeDefinition> = {
  ...
  skeuomorphic: {
    ...
    season: '实体拟物',
    icon: '🗓️',
    description: '模拟复古螺旋金属圈活页桌历，牛皮纸质感与精致金属装订',
    containerBorder: 'border-[#b89569] dark:border-[#5c4731]',
    weekdayHeaderBg: 'bg-[#e8dcbe] dark:bg-[#3d3123]',
    weekdayHeaderBorder: 'border-[#cfbe9b] dark:border-[#574633]',
    weekdayTextColor: 'text-[#4d3219] dark:text-[#f0deb9]',
    selectedRing: 'ring-[#a35c24]',
    selectedBg: 'bg-[#f7eedc] dark:bg-[#473827]',
    todayBadgeBg: 'bg-[#b83b27]',
    todayBadgeText: 'text-white font-serif font-black',
    tripBadgeBg: 'bg-[#faf4e6] dark:bg-[#3b3023]',
    tripBadgeText: 'text-[#5c2d12] dark:text-[#f5dec6]',
    tripBadgeBorder: 'border-[#dfcfb4] dark:border-[#5c4935]',
    totalBadgeBg: 'bg-[#b83b27]',
    totalBadgeText: 'text-white font-serif font-black',
    accentColor: '#a35c24',
  },
};
